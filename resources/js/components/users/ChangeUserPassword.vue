<template>
    <div>
        <div class="card mt-3">
            <div class="card-body">
                <h3>
                    <button class="btn btn-outline-primary btn-sm me-3" @click="$emit('view-dashboard')">
                        <i class="fas fa-chevron-left"></i> Back</button>Change User Password - <small class="text-muted"><b>{{ user.name }}</b></small>
                    <button class="btn btn-sm btn-outline-primary float-end" @click.prevent="sendResetLink">Send Reset Link</button>
                </h3>
