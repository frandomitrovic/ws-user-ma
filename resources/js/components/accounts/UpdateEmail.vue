<template>
    <div>
        <div class="card mt-3">
            <div class="card-body">
                <h3>
                    <button class="btn btn-outline-primary btn-sm me-3" @click="$emit('view-dashboard')"><i class="fas fa-chevron-left"></i> Back</button>
                ...
                <div class="form-group row mb-3">
                    <label class="col-3">New Email</label>
                    <div class="col-9">
                        <input type="email" class="form-control" v-model="data.email">
                    </div>
                </div>
                <div class="form-group row mb-3">
                    <label for="" class="col-3">Enter Password to Confirm</label>
                    <div class="col-9">
        ...
        methods: {
            updateEmail: function() {
                ...
                axios.post('/data/accounts/updates/email/' + this.user.id, {
                    ...
                    this.$emit('updated-email', 'Succesfully updated the email for ' + this.user.name)
                }).catch(errors => {
                    console.dir(errors)
